...
public class DataInitializer implements CommandLineRunner {
    ...
    private List<FlightRecord> generateFlights() {
        return List.of(
                ...
                FlightRecord.builder().id(UUID.randomUUID()).origin("SYD").destination("AMS").image("https://images.alphacoders.com/738/738037.jpg").departure(LocalDateTime.of(2023, 12, 17, 16, 30)).arrival(LocalDateTime.of(2023, 12, 17, 23, 55)).price(125.4).build(),
